        ...
        >
          ...
          >
            <div className="modal-header" style={{ padding: '16px', borderBottom: '1px solid #f0f0f0', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <span className="modal-title" style={{ fontSize: '16px', fontWeight: '600', color: '#2C2C2C' }}>新建任务</span>
              <span className="modal-close" onClick={() => setShowTaskModal(false)} style={{ fontSize: '20px', color: '#999', cursor: 'pointer', padding: '4px' }}>✕</span>
            </div>
